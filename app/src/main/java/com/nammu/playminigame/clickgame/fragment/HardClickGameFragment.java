...
public class HardClickGameFragment extends Fragment {
    public HardClickGameFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_clickgame_hard, container, false );
